...
public class GameTest extends TestCase {
    ...
    public void testing(){
        ...
        game.getPlayer(0).placePF(farEast.getName(), 5);
        game.getPlayer(0).placePF(italy.getName(), 5);
        game.getPlayer(0).placePF(turkey.getName(), 5);
        game.getPlayer(0).placePF(greece.getName(), 5);

        game.getPlayer(1).placePF(africa.getName(), 10);
        game.getPlayer(1).placePF(russia.getName(), 5);
        game.getPlayer(1).placePF(britain.getName(), 7);

        game.getPlayer(2).placePF(austria.getName(), 5);
        game.getPlayer(2).placePF(africa.getName(), 5);
        game.getPlayer(2).placePF(russia.getName(), 3);
        game.getPlayer(2).placePF(italy.getName(), 8);

        game.getPlayer(3).placePF(serbia.getName(), 3);
        game.getPlayer(3).placePF(turkey.getName(), 10);
        game.getPlayer(3).placePF(romania.getName(), 7);

        game.getPlayer(4).placePF(serbia.getName(), 10);
        game.getPlayer(4).placePF(germany.getName(), 3);
...
//        actions = game.getPlayer(0).minimaxDecision(board);
        int start, maxLoop, maxNode;

        /** PURE minimax **/
//        maxLoop = 6;
//        for (int i=1; i<=maxLoop; i++) {
//            file.WriteFile("PURE minimax -> max level: " + i);
//            start = getTimeInSec();
//            actions = game.getPlayer(0).autoAction3(board, i, 3, false);
...
//        }
        ...
        for (int l=1; l<=maxLoop; l++){
            for (int n=2; n<=maxNode; n++){
                file.WriteFile("RANDOM minimax -> max level: " + l + ", max node: " + n);
                start = getTimeInSec();
                actions = game.getPlayer(0).autoAction4(board, l, n, false);
                writeActions(actions);
                file.WriteFile("Total time spent: " + (getTimeInSec() - start) + " seconds");
                file.WriteFile("--------------------------------------------------------------------");
            }
        ...
        for (int l=1; l<=maxLoop; l++){
            for (int n=2; n<=maxNode; n++){
                file.WriteFile("SCORE minimax -> max level: " + l + ", max node: " + n);
                start = getTimeInSec();
                actions = game.getPlayer(0).autoAction2(board, l, n, false);
                writeActions(actions);
                file.WriteFile("Total time spent: " + (getTimeInSec() - start) + " seconds");
                file.WriteFile("--------------------------------------------------------------------");
            }
...
//        start = getTimeInSec();
//        actions = game.getPlayer(0).autoAction2(board, 6, 5, true);
//        writeActions(actions);
//        file.WriteFile("Total time spent: " + (getTimeInSec() - start) + " seconds");
//        file.WriteFile("--------------------------------------------------------------------");
//
...
//
//        start = getTimeInSec();
//        actions = game.getPlayer(0).autoAction2(board, 11, 3, true);
//        writeActions(actions);
//        file.WriteFile("Total time spent: " + (getTimeInSec() - start) + " seconds");
//        file.WriteFile("--------------------------------------------------------------------");
//
//        start = getTimeInSec();
//        actions = game.getPlayer(0).autoAction2(board, 11, 5, true);
//        writeActions(actions);
//        file.WriteFile("Total time spent: " + (getTimeInSec() - start) + " seconds");
//        file.WriteFile("--------------------------------------------------------------------");
//
//        start = getTimeInSec();
//        actions = game.getPlayer(0).autoAction2(board, 11, 7, true);
//        writeActions(actions);
//        file.WriteFile("Total time spent: " + (getTimeInSec() - start) + " seconds");
