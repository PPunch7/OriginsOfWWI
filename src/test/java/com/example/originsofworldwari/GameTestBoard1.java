...
public class GameTestBoard1 extends TestCase {
...
//        start = getTimeInSec();
//        actions = game.getPlayer(0).autoAction2(board, 11, 3, false);
//        writeActions(actions);
//        file.WriteFile("Total time spent: " + (getTimeInSec() - start) + " seconds");
//        file.WriteFile("--------------------------------------------------------------------");
//
//        start = getTimeInSec();
//        actions = game.getPlayer(0).autoAction4(board, 11, 3, false);
//        writeActions(actions);
//        file.WriteFile("Total time spent: " + (getTimeInSec() - start) + " seconds");
//        file.WriteFile("--------------------------------------------------------------------");
