...
public class GameTestBoard3 extends TestCase {
    ...
    public void testing(){
        ...
        game.getPlayer(0).placePF(italy.getName(), 9);
        game.getPlayer(0).placePF(greece.getName(), 11);
        game.getPlayer(0).placePF(turkey.getName(), 4);
        game.getPlayer(0).placePF(farEast.getName(), 10);

        game.getPlayer(1).placePF(britain.getName(), 8);
        game.getPlayer(1).placePF(russia.getName(), 15);
        game.getPlayer(1).placePF(austria.getName(), 5);
        game.getPlayer(1).placePF(italy.getName(), 3);
        game.getPlayer(1).placePF(africa.getName(), 10);

        game.getPlayer(2).placePF(russia.getName(), 5);
        game.getPlayer(2).placePF(austria.getName(), 13);
        game.getPlayer(2).placePF(italy.getName(), 11);
        game.getPlayer(2).placePF(greece.getName(), 7);
        game.getPlayer(2).placePF(turkey.getName(), 5);
        game.getPlayer(2).placePF(farEast.getName(), 3);
        game.getPlayer(2).placePF(africa.getName(), 5);

        game.getPlayer(3).placePF(serbia.getName(), 8);
        game.getPlayer(3).placePF(romania.getName(), 11);
        game.getPlayer(3).placePF(bulgaria.getName(), 6);
        game.getPlayer(3).placePF(greece.getName(), 3);
        game.getPlayer(3).placePF(turkey.getName(), 14);
        game.getPlayer(3).placePF(farEast.getName(), 9);

        game.getPlayer(4).placePF(germany.getName(), 10);
        game.getPlayer(4).placePF(serbia.getName(), 13);
        game.getPlayer(4).placePF(romania.getName(), 9);
